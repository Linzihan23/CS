...
% =========================================================================
% Input parameters:
% Data;% param;% K;% numIteration;% errorFlag;%preserveDCAtom;
% InitializationMethod;%displayProgress;
% =========================================================================
% Output parameters:
% Dictionary;%output;%CoefMatrix;
% ratio;%totalerr;%numCoef;
% =========================================================================
...
[betterDictionaryElement,singularValue,betaVector] = svds(errors,1);%调用MATLAB字库中的SVD算法
CoefMatrix(j,relevantDataIndices) = singularValue*betaVector';% *第一个元素的标志
